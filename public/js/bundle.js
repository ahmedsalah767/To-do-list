...
var login = function login(_x, _x2) {
  return (_ref = _ref || _asyncToGenerator(
  /*#__PURE__*/
...
var logout = function logout() {
  return (_ref2 = _ref2 || _asyncToGenerator(
  /*#__PURE__*/
...
var signup = function signup(_x3, _x4, _x5, _x6) {
  return (_ref3 = _ref3 || _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee3(email, password, passwordConfirm, name) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"tasks.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.delTask = exports.create = void 0;
...
var create = function create(_x, _x2, _x3, _x4, _x5) {
  return (_ref = _ref || _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(title, category, description, pirorety, dueDate) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alert.showAlert)('error', 'some fields are mandatory');
          console.log(_context.t0.response.data);
...
var delTask = function delTask(_x6) {
  return (_ref2 = _ref2 || _asyncToGenerator(
  /*#__PURE__*/
...
var out = document.querySelector('.logout-btn');
var createForm = document.querySelector('.form-tasks');
var deleteTask = document.querySelector('.del-task-btn');
out.addEventListener('click', _login.logout);
var deleteButtons = document.querySelectorAll('.del-task-btn');
...
if (createForm) {
  createForm.addEventListener('submit', function (e) {
    ...
    var pirorety = document.getElementById('pirorety').value;
    var category = document.getElementById('category').value;
    (0, _tasks.create)(title, category, description, pirorety, dueDate);
  });
}
},{"./login":"login.js","./tasks":"tasks.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
